...
const LocalArea = () => {
  return (
    <LocalAreaStyled id="LocalArea">
      <div className="text-container">
        <h1>Local Area</h1>
        <p>
          Within walking distance of the racecourse and in the centre of the
          city centre nightlife, The Assembly really is the perfect place to
          assemble!{" "}
        </p>
      </div>
